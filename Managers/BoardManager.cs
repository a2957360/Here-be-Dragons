...
public class BoardManager : MonoBehaviour
{
    ...
    public void SetupScene(int level)
    {
        ...
        //LayoutObjectAtRandom(obstableTiles, obstableCount.minimum, obstableCount.maximum);

        //Instantiate a random number of food tiles based on minimum and maximum, at randomized positions.
        //LayoutObjectAtRandom(chestTiles, chestCount.minimum, chestCount.maximum, false);

        //Determine number of enemies based on current level number, based on a logarithmic progression

        //LayoutObjectAtRandom(heroTiles, heroCount, heroCount, true);
